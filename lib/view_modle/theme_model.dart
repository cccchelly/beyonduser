...
import 'package:beyond_user/ui/helper/theme_helper.dart';
...
class ThemeModel with ChangeNotifier {
  ...
  ThemeModel() {
    ...
    /// 获取主题色   这里不做主题动态切换   直接上面初始化写死了  需要修改配置一下即可
    /*_themeColor = Colors.primaries[
        StorageManager.sharedPreferences.getInt(kThemeColorIndex) ?? 0];*/
    const int mainColor = LocalColors.mainColor;
    _themeColor = MaterialColor(mainColor, const <int,Color>{
      50: Color(mainColor),
      100: Color(mainColor),
      200: Color(mainColor),
      300: Color(mainColor),
  ...
  ThemeData get lightTheme => _themeData.copyWith(brightness: Brightness.light);
